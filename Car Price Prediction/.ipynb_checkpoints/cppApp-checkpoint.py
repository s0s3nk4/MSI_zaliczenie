...
mileage = st.slider('Car Mileage', 1,40)
engine = st.slider('Engine Capacity', 500,5000)
power = st.slider('Max Power', 50,500)
...
if st.button("Predict"):
    input_data_model = pd.DataFrame(
        ...
        columns = ['name', 'year', 'km_driven', 'fuel', 'seler_type', 'transmission', 'owner', 'mileage', 'engine', 'max_power', 'seats']
    )
